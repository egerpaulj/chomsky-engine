            ...
            Host.CreateDefaultBuilder(args)
                ...
                .ConfigureServices(
                    (hostContext, services) =>
                    {
                        ...
                        services.AddSingleton<IMongoDbRepository<CrawlRequestModel>>(
                        ...
                        services.AddKeyedTransient<
                            ...
                            BertrandCleanerExchangeFactory
                        >(nameof(BertrandCleanerExchangeFactory));

                        services.AddKeyedTransient<
                            IBertrandExchangeFactory,
                            BertrandAdhocExchangeFactory
                        >(nameof(BertrandAdhocExchangeFactory));
                    }
                );
    }
}
