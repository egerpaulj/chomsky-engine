...
namespace Microservice.Elasticsearch.Repo
{
    public interface IElasticsearchRepository
    {
        ...
        /// </summary>
        TryOptionAsync<Unit> IndexDocument<T>(Option<T> document, Option<string> indexKey)
            where T : IDataModel;

        /// <summary>
        /// Search elastic-search for documents of type T; based on the query.
        /// </summary>
        TryOptionAsync<List<T>> Search<T>(Option<string> index, Option<string> queryJson)
