...
{
    public class OnetimeContinuationStrategy : ICrawlContinuationStrategy
    {
        private readonly IRequestPublisher _requestPublisher;

        public OnetimeContinuationStrategy(IRequestPublisher requestPublisher)
        {
        ...
        public TryOptionAsync<Unit> Apply(Option<CrawlResponse> response)
        {
            ...
            return response
                ...
                .Bind(links => _requestPublisher.PublishUri(baseUri, links, UriType.Onetime));
        }
