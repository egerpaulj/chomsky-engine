...
namespace Crawler.Core.UnitTest
{
    public class TestCaseFactoryTable
    {
        ...
        public static ExpectedTable CreateExpectedTable()
        {
            ...
            {
                Headers = new List<string> { "Header 1\n", "Header 2\n" },
                Rows = new List<ExpectedRow>
                {
                    new ExpectedRow
                    {
                        Content = new List<string> { "It could just be me", "row data 2" },
                    },
                    new ExpectedRow
                    {
                        Content = new List<string> { "row 2: 1", "row 2: 2" },
                    },
                    new ExpectedRow
                    {
                        Content = new List<string> { "row 3: 1", "row 3: 2" },
                    },
                    new ExpectedRow
                    {
                        Content = new List<string> { "row 4: 1", "row 4: 2" },
                    },
                },
            };
        }
