        ...
        )
        {
            ...
            switch (docType)
            {
                ...
                case DocumentPartType.AutoDetect:
                    return JsonConvert.DeserializeObject<DocumentPartAutodetect>(
                        jo.ToString(),
                        this
                    );
                ...
                case DocumentPartType.Meta:
                    return JsonConvert.DeserializeObject<DocumentPartMeta>(jo.ToString(), this);
                default:
                    throw new Exception();
            }
