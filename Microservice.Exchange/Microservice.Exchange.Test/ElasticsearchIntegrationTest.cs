    ...
    public class ElasticsearchIntegrationTest
    {
        ...
        public async Task SetUp()
        {
            ...
            _configuration = TestHelper.TestHelper.GetConfiguration(
                $"{TestHelper.TestHelper.GetEnvironment()}.Elasticsearch"
            );
        ...
        public async Task CreateExchangeFromConfiguration_WhenFileCopied_ThenTransformedToOutput()
        {
            ...
            File.Move(
                $"testData/elasticsearch/{fileNameAsGuid}",
                $"testData/elasticsearch/in/{fileNameAsGuid}"
            );
            ...
            var result = await File.ReadAllTextAsync(
                $"testData/elasticsearch/out/{fileNameAsGuid}"
            );

            var outputMessage = new EmptyJsonConverterProvider().Deserialize<TestEsOutputMessage>(
                result
            );
