    ...
    public class MongodbIntegrationTest
    {
        ...
        public async Task SetUp()
        {
            ...
            _configuration = TestHelper.TestHelper.GetConfiguration(
                $"{TestHelper.TestHelper.GetEnvironment()}.Mongodb"
            );
            ...
            var mongoRepo = new MongoDbRepository<TestOutputMessage>(
                _configuration,
                mongodbConfigMock.Object,
                new EmptyJsonConverterProvider()
            );
            await mongoRepo
                .Delete(Builders<BsonDocument>.Filter.Where(r => true))
                .Match(r => { }, () => { });
        }
        ...
        public async Task CreateExchangeFromConfiguration_WhenFileCopied_ThenTransformedToOutput()
        {
            ...
            File.Move(
                $"testData/mongodb/{fileNameAsGuid}",
                $"testData/mongodb/in/{fileNameAsGuid}"
            );
