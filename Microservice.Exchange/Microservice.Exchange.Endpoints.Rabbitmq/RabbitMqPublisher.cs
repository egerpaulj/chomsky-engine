...
namespace Microservice.Exchange.Endpoints.Rabbitmq
{
    ...
    /// </summary>
    public class RabbitMqPublisher<T, R>
        : IPublisher<R>,
            ...
            IConfigInitializor
    {
        ...
        public RabbitMqPublisher(
            ILogger<RabbitMqPublisher<T, R>> logger,
            ...
            return configuration
                ...
                .Bind<IConfiguration, Unit>(config =>
                    async () =>
                    {
                        ...
                        _publisher = AmqpProvider.CreatePublisher(
                            Name,
        ...
        public TryOptionAsync<Unit> Publish(Option<Message<R>> message)
        {
            return message
                .ToTryOptionAsync()
                .Bind(m =>
                    _publisher.Publish<R>(
                        new Microservice.Amqp.Message<R>
                        {
                            Id = m.Id,
    ...
    public class RabbitMqPublisher<T>(string name, IMessagePublisher messagePublisher)
        : IPublisher<T>
    {
