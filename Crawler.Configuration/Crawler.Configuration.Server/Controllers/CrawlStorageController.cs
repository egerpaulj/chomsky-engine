...
namespace Crawler.Configuration.Server.Controllers
{
    ...
    public class CrawlStorageController : ControllerBase
    {
        ...
        public CrawlStorageController(ILogger<CrawlStorageController> logger, ICrawlerConfigurationService config)
        {
            _logger = logger;
        ...
        {
            await _configurationService.Add(dataModel).Match(r => {}, 
        ...
        {
            await _configurationService.UpdateCompletedTimeUtcNow(Guid.Parse(id.Value)).Match(r => {}, 
        ...
        {
            await _configurationService.UpdateScheduledTimeUtcNow(Guid.Parse(id.Value)).Match(r => {}, 
        ...
        {
            await _configurationService.StoreDetectedUrls(request.Links, HttpContext.GetCorrelationId()).Match(r => {}, 
