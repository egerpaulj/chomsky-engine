...
namespace Microservice.Amqp.Rabbitmq.Test
{
    ...
    public class MessagePublisherTest
    {
        ...
        {
            // ARRANGE
            var connectionFactoryMock = TestHelper.GetConnectionFactoryMock(
                out var connection,
                out var model
            );
            ...
            var testee = new MessagePublisher(
                rabbitmqConfig,
            ...
            // ACT
            await testee
                .Publish<TestRequestMessage>(new TestRequestMessage { TestId = "Test Id" })
                .Match(r => { }, () => { });
