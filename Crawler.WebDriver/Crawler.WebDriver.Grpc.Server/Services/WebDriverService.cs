...
namespace Crawler.WebDriver.Grpc.Server
{
    public class WebDriverService : RpcServiceBase<DriverRequest, DriverResponse>
    {
        ...
        public WebDriverService(ILogger<Rpc.RpcBase> logger, IGrpcMetrics metrics, IWebDriverService webDriverService, IJsonConverterProvider jsonConverterProvider) 
        ...
        {
            return _webDriverService.LoadPage(request)
        ...
        {
            return _webDriverService.Download(request)
